...
# 获取青龙环境变量
def get_credentials_from_env(env_var_name):
    try:
        ...
        print(f"环境变量 {env_var_name} 格式不正确，应为 'user,pwd'")
        return None, None


# 定义变量  USER、PWD、OPEN_GET_WEATHER、AREA
USER, PWD = get_credentials_from_env("ZeppLife")
