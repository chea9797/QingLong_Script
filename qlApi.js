...
function getQLToken() {
  return new Promise((resolve, reject) => {
    axios.get(QL_URL + `/open/auth/token?client_id=${CLIENT_ID}&client_secret=${CLIENT_SECRET}`).then((res) => {
 ...
 */
async function init() {
  if (!CLIENT_ID || !CLIENT_SECRET) return Promise.reject("未获取到 CLIENT_ID 或 CLIENT_SECRET");
